...
<div class="history-container">
    <div class="header-row">
        <h3><Icon name="archive" size={20} /> <span class="title-text">SQLite Scan History</span></h3>
        {#if history.length > 0}
                    ...
                    <div class="details-container">
                        ...
                        <div class="meta-row">
                            <span class="conf-badge">
                                <Icon name="target" size={12} /> {Math.round(item.confidence * 100)}% Match
                            </span>
                            <span class="time-stamp">
                                <Icon name="calendar" size={12} /> {item.timestamp}
                            </span>
                        </div>
                    </div>
...
<style>
    ...
    .header-row h3 :global(.vi-icon) {
        color: var(--primary);
    }

    .header-row h3 .title-text {
